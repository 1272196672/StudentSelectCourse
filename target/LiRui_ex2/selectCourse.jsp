...
<%
    ...
    ArrayList<Map<String, Object>> courseCanBeSelected = (ArrayList)request.getSession().getAttribute("courseCanBeSelected");
%>
...
<nav>
    <ul class="layui-nav layui-bg-cyan ">
        ...
        <li class="layui-nav-item  layui-this">
            ...
            <dl class="layui-nav-child">
                <dd><a href="/LiRui_ex2_war/showSelect?id=<%=id%>">已选课程</a></dd>
                <dd class="layui-this"><a href="/LiRui_ex2_war/courseCanSelect?id=<%=id%>">选课列表</a></dd>
            </dl>
        </li>
    </ul>
</nav>
    ...
    <div class="layui-col-md11 site-content">
        <table class="layui-table" style="margin-left: 150px;">
            ...
            <tr>
                ...
                <th><strong>选课</strong></th>
            </tr>
            </thead>
            <tbody>
            <%
                for (Map<String, Object> course : courseCanBeSelected) {
            %>
            <tr>
                <td><%=course.get("id")%></td>
                <td><%=course.get("name")%></td>
                <td><%=course.get("teacherName")%></td>
                <td><a href="/LiRui_ex2_war/sentMq?id=<%=id%>&courseId=<%=course.get("id")%>"><span style="color: red">选课</span></a></td>
            </tr>
            <%
                }
            %>
